...
def enregistreQmu():
    ...
    liste_reponses=[{'fraction':0,'text':choix1},{'fraction':0,'text':choix2},{'fraction':0,'text':choix3},{'fraction':0,'text':choix4}]
    # affectation du score 100 à la réponse attendue parmi les choix
    text_bonchoix=str(bonchoix)
    numero=0
    for q in liste_reponses:
        if str(numero) in text_bonchoix:
            q['fraction']=100
        numero=numero+1
    partie_questionnaire={'enonce':question,'reponses':liste_reponses,'type':types[0]}
...
#--définition de la fonction qui sauvegarde le questionnaire dans un fichier json  
...
entr7 = Entry(fen1,width=25)

listechoix = Listbox(fen1,width=7,heigh=4)
listechoix.insert(0,'choix 1')
listechoix.insert(1,'choix 2')
listechoix.insert(2,'choix 3')
listechoix.insert(3,'choix 4')
...
txt20.grid(row =5,column =0,sticky =E)
txt5.grid(row =6,column =0,sticky =E)
txt6.grid(row =1,column =3,sticky =E)
txt7.grid(row =2,column =3,sticky =E)
txt8.grid(row =8,column =3,sticky =E)
txt9.grid(row =8,column =0,sticky =E)
txt10.grid(row =8,column =4,sticky =W)
txt11.grid(row =8,column =1,sticky =W)
...
txt19.grid(row =8,column =2,sticky =W)


bou1.grid(row =7, column =1,sticky =W)
bou2.grid(row =9, column =3,sticky =W)
bou3.grid(row =10, column =3,sticky =W)
...
entr7.grid(row =5, column =1,sticky =W)

listechoix.grid(row =6, column =1,sticky =W)
